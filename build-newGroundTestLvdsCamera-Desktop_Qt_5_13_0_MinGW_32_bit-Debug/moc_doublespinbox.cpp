...
#include <memory>
#include "../newGroundTestLvdsCameraL_ZGG/frameFormat/doublespinbox.h"
...
QT_INIT_METAOBJECT const QMetaObject DoubleSpinBox::staticMetaObject = { {
    &QDoubleSpinBox::staticMetaObject,
    qt_meta_stringdata_DoubleSpinBox.data,
